<div class="panel panel-info" id="photoPanel">
    ...
    <div class="panel-body form-horizontal">
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <input type="file" name="photo[]" id="files" class="form-control" accept="image/*" id="inputPhoto">
        ...
        <label class="col-lg-2 control-label"></label>
			...
			<?php
				foreach($photos as $photo){
					echo '<img src="'.$photo->image_path_thumb().'" id="productBox">';
				}
			?>
        ...
        <div class="form-group">
          <div class="col-lg-offset-2 col-lg-10">
            <input type="submit" name="save" data-loading-text="Loading..." style="max-width: 200px;" class="btn btn-success btn-lg btn-block" Value="Submit">
          </div>
        </div>
        <?php endif;?>
    </div>
