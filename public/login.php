<?php
	...
	if (isset($_POST['login'])) {
		...
		if(!$found_user){
			...
			$found_user = User::authenticate_phone($phone, $password);
		}
...
Click on the link to change it :  https://swiftdeal.in/public/login.php?query=changepwd&email={$user->email}&access_token={$user->access_token}

Add any of your unused stuffs and make profit sitting at home : https://swiftdeal.in/public/addstuffs.php?type=individual

For any Doubt visit : https://swiftdeal.in/public/faq.php
