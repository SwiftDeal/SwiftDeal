...
class Call extends DatabaseObject
{
	...
	protected static $db_fields = array('id', 'name', 'user_id', 'customer_id', 'phone', 'email', 'category', 'details', 'call_history', 
								'reminder', 'address', 'city', 'created', 'validity', 'status', 'updated');

	public static function call_history($id, $name) {
		global $database;
		$sql  = "UPDATE ".self::$table_name." SET ";
		$sql .= "call_history = CONCAT(call_history,', ".$name."') ";
		$sql .= "WHERE id = {$id}";
		$database->query($sql);
